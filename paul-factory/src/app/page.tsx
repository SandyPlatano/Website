...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <PageSection id="about" bleed className="bg-primary-background px-6 py-12 md:px-10 md:py-16 lg:px-16 lg:py-20">
        <div className="mx-auto w-full max-w-7xl rounded-3xl bg-white/70 px-6 py-10 shadow-card md:max-w-content-wide md:px-10 md:py-12 lg:px-16 lg:py-16">
          <div className="space-y-6 md:space-y-8">
            <div className="w-full space-y-6 rounded-3xl border border-sky-400/40 bg-[#03111F] p-6 text-white md:space-y-8 md:p-10 lg:p-12">
              <div className="space-y-6 md:space-y-8">
